      ...
      <div className="container-premium relative z-10 reveal">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div>
            ...
            <h1 className="text-5xl font-extrabold text-awt-text-primary tracking-tight leading-tight">Data <span className="text-blue-500 italic">Analytics</span></h1>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {[
            ...
            { label: 'Mysales Trials', value: '89', trend: '+24%', color: 'purple' },
            ...
            <div key={i} className="glass-card p-8 group reveal" style={{ animationDelay: `${i * 0.1}s` }}>
              ...
              <div className="text-4xl font-black text-awt-text-primary tracking-tighter">{stat.value}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-8">
          <div className="glass-card p-10 h-[500px] flex flex-col reveal" style={{ animationDelay: '0.4s' }}>
            <div className="flex justify-between items-center mb-10">
              <h3 className="text-2xl font-bold text-awt-text-primary tracking-tight">Traffic Signal Density</h3>
              <div className="flex gap-2">
                {['24H', '7D', '30D'].map(t => (
                  <button key={t} className="text-[9px] font-bold px-3 py-1 bg-white/5 text-awt-text-secondary rounded-full hover:bg-black/10 hover:text-awt-text-primary transition-all">{t}</button>
                ))}
              </div>
            </div>
          ...
          <div className="glass-card p-10 h-[500px] flex flex-col reveal" style={{ animationDelay: '0.5s' }}>
            <div className="flex justify-between items-center mb-10">
              <h3 className="text-2xl font-bold text-awt-text-primary tracking-tight">Conversion Matrix</h3>
